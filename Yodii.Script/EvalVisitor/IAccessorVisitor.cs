...
namespace Yodii.Script
{
    ...
    public interface IAccessorVisitor
    {
        ...
        /// the <see cref="IAccessorFrame.SetRuntimeError"/> or <see cref="IAccessorFrame.SetResult"/> methods on the 
        /// deepest handled frame must then be called to store the result and shortcut the evaluation process.
        /// </summary>
